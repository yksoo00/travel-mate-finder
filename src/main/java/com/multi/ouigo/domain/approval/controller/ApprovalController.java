...
public class ApprovalController {
    ...
    public ResponseEntity<ResponseNoDateDto> deleteApproval(@PathVariable Long approvalId,
        HttpServletRequest request) {
        approvalService.deleteApproval(request, approvalId);
        return ResponseEntity.ok().body(new ResponseNoDateDto(HttpStatus.NO_CONTENT, "모집 글 삭제 완료"));
    }
