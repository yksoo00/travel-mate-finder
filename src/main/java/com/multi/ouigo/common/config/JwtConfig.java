        ...
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .sessionManagement(
                sesstion -> sesstion.sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                    ...
                    .requestMatchers("/layout/**", "/tourist/**").permitAll()
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/tourist-spots").permitAll()
//                    .hasAnyRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/v1/tourist-spots/*").permitAll()
//                    .hasAnyRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/v1/tourist-spots/*").permitAll()
//                    .hasAnyRole("ADMIN")
